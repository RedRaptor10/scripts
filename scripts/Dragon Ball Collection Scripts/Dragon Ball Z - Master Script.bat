:: Dragon Ball Z - Master Script
::
:: Description:
:: Takes an input batch file and runs a target script that plays an episode file with the same name.
:: This provides a "one-click" solution for the Dragon Ball Z script without having to drag files onto the script.
::
:: Requirements:
:: - Dragon Ball Z script that sets the default audio+subtitle track and opening/ending
:: - Batch (.bat) files using the same filename and folder structure as the episode files
::
:: 		Example:
:: 		Dragon Ball Z\Season 01\Dragon Ball Z - S01E01 - The New Threat.mkv
:: 		<some folder>\Season 01\Dragon Ball Z - S01E01 - The New Threat.bat
::
:: - The batch files should run a simple command that calls this master script:
::
:: 		Example:
:: 		"..\..\Dragon Ball Z - Master Script.bat" "%~n0"
::
:: Instructions:
...
:: Set Script Path
SET script="M:\Extras\Dragon Ball Z\Batch Scripts\Dragon Ball Z - Set Default Audio+Subtitle Track & Opening+Ending.bat"

:: Set Show Folder Path
SET show_folder=M:\TV Shows\Dragon Ball Z
